...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Reserved " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"reservedtools.com", "dnsseed.reservedtools.com"},
    {"reservedpool.org", "dnsseed.reservedpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"reservedtools.com", "testnet-seed.reservedtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Reserved is probably already running."), addrBind.ToString().c_str());
        else
